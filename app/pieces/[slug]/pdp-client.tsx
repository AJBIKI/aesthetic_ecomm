...
export function ProductDetailClient({ product, relatedProducts }: PDPClientProps) {
  ...
  return (
    <div className="py-12 md:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="border-b-2 border-[oklch(0.13_0.02_260)] pb-6 flex flex-col md:flex-row md:items-end justify-between">
        ...
        <div className="pt-4 md:pt-0 font-mono text-xs text-[oklch(0.48_0.01_255)] uppercase tracking-[0.2em] flex items-center space-x-4">
          <span>CAT NO. {product.id.toUpperCase()}</span>
          <span>•</span>
          <span className="text-[oklch(0.13_0.02_260)] font-bold">₹{product.price.toLocaleString('en-IN')}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="relative">
            <motion.div
              ...
              className="relative aspect-[4/5] w-full rounded-xs overflow-hidden bg-[oklch(0.925_0.008_245)] border border-[oklch(0.86_0.006_250)] shadow-2xl"
            >
              <Image
              ...
              <div className="absolute top-6 left-6 bg-[oklch(0.135_0.02_260)]/90 backdrop-blur-md text-[oklch(0.93_0.005_250)] px-3 py-1.5 rounded-xs font-mono text-[10px] uppercase tracking-[0.2em]">
              ...
              <button
                ...
                className={`relative aspect-[4/5] rounded-xs overflow-hidden border-2 transition-all ${
                  selectedImageIndex === idx
                    ...
                    : 'border-[oklch(0.86_0.006_250)] opacity-70 hover:opacity-100'
                }`}
              >
          ...
          <blockquote className="p-8 bg-[oklch(0.925_0.008_245)] rounded-xs border border-[oklch(0.86_0.006_250)] italic font-display text-xl sm:text-2xl text-[oklch(0.13_0.02_260)] leading-relaxed">
            "{product.tagline}"
          </blockquote>
        </div>
        ...
        <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-28">
          ...
          <div className="bg-[oklch(0.955_0.005_250)] p-8 rounded-xs border border-[oklch(0.86_0.006_250)] shadow-xl space-y-8">
            ...
            <div className="flex items-center justify-between border-b border-[oklch(0.86_0.006_250)] pb-4">
              ...
              <span className="text-[10px] font-mono text-[oklch(0.48_0.01_255)]">IN STOCK</span>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center justify-between text-xs font-mono">
                <span className="uppercase tracking-[0.15em] text-[oklch(0.13_0.02_260)]">
                  SELECT ATELIER SIZE
                </span>
            ...
            <div className="flex items-center space-x-4 pt-2">
              <button
                onClick={handleAdd}
                className="flex-1 bg-[oklch(0.13_0.02_260)] text-[oklch(0.93_0.005_250)] py-4 px-8 rounded-xs text-xs uppercase tracking-[0.2em] font-medium hover:bg-[oklch(0.55_0.12_195)] transition-colors flex items-center justify-center space-x-2 shadow-lg"
              >
                {added ? (
                  <>
      ...
      {relatedProducts.length > 0 && (
        <section className="mt-28 border-t-2 border-[oklch(0.13_0.02_260)] pt-16">
          <div className="mb-10 flex items-center justify-between border-b border-[oklch(0.86_0.006_250)] pb-4">
            <h3
