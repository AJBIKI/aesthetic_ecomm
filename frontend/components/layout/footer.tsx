...
export function Footer() {
  return (
    <footer data-dark="true" className="bg-[oklch(0.14_0.03_145)] text-[oklch(0.93_0.015_145)] border-t border-[oklch(0.45_0.02_145)]/20 pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-[oklch(0.48_0.01_255)]/20">
          ...
          <div className="md:col-span-5 space-y-4">
            <span
              className="text-3xl font-display tracking-[0.2em] text-[oklch(0.93_0.015_145)] block"
