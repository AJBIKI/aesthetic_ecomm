            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {bag.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center space-y-4 text-[oklch(0.48_0.01_255)]">
                  <p className="font-display text-lg italic text-[oklch(0.13_0.02_260)]" style={{ fontFamily: 'var(--font-cormorant), "Cormorant Garamond", Georgia, serif' }}>
                    Your bag is waiting.
                  </p>
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div>
                        <div className="flex items-start justify-between">
                          <h4 className="font-display text-base tracking-wide" style={{ fontFamily: 'var(--font-cormorant), "Cormorant Garamond", Georgia, serif' }}>
                            {item.product.name}
                          </h4>
                          <button
