...
export function MagazineIndex() {
  ...
  return (
    <section data-dark="true" className="py-10 md:py-24 bg-[oklch(0.14_0.03_145)] text-[oklch(0.93_0.015_145)] border-y border-[oklch(0.45_0.02_145)]/20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[oklch(0.45_0.02_145)]/30 pb-6 mb-12">
          <div className="space-y-2">
            ...
            <h2
              className="text-3xl sm:text-5xl font-display text-[oklch(0.93_0.015_145)] tracking-wide"
          ...
          <p className="text-xs font-mono uppercase tracking-[0.2em] text-[oklch(0.45_0.02_145)] pt-4 md:pt-0">
          ...
          <div className="lg:col-span-7 space-y-2">
            {products.map((item, idx) => (
              <Link
                ...
                onMouseEnter={() => handleHoverProduct(item)}
                onMouseLeave={() => setIsHovering(false)}
                className="group flex items-center justify-between p-4 border-b border-[oklch(0.45_0.02_145)]/20 hover:border-[oklch(0.55_0.12_195)] hover:bg-[oklch(0.55_0.12_195)]/10 transition-all rounded-xs"
              >
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <h3
                      className="text-xl sm:text-2xl font-display text-[oklch(0.93_0.015_145)] group-hover:text-[oklch(0.55_0.12_195)] transition-colors"
                      style={{ fontFamily: 'var(--font-cormorant), "Cormorant Garamond", Georgia, serif' }}
                    >
                      {item.name}
                    </h3>
                    <p className="text-[11px] font-mono text-[oklch(0.45_0.02_145)] uppercase tracking-wider">
                ...
                <div className="flex items-center space-x-4">
                  <span className="font-mono text-xs text-[oklch(0.82_0.05_145)]">
            ...
            <div className="relative aspect-[3/4] w-full rounded-xs overflow-hidden border border-[oklch(0.55_0.12_195)]/40 shadow-2xl bg-black">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-[oklch(0.14_0.03_145)]/90 backdrop-blur-md p-4 rounded-xs border border-[oklch(0.55_0.12_195)]/40 space-y-1">
                    ...
                    <p className="text-[11px] font-mono text-[oklch(0.45_0.02_145)]">
