...
export function LookbookScroll() {
  ...
  return (
    <section ref={containerRef} className="relative h-[200vh] bg-[oklch(0.135_0.02_260)] text-[oklch(0.93_0.005_250)]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
          ...
          >
            ...
            <h2
              className="text-4xl sm:text-5xl lg:text-6xl font-display leading-[1.08] tracking-wide"
              style={{ fontFamily: 'var(--font-fraunces), Georgia, serif' }}
            >
              When the rain falls, silhouette becomes everything.
            </h2>
